...
| 10 | **Emparejar la búsqueda de texto con la de foto** (geo modulador + umbral calibrado + categoría desde texto) | EU-337 | 5 | **HECHO** (Jira Done) — creada el 2026-08-06, **ver §13**. Implementada en el commit `afa476d` | Los tres puntos van juntos: cambiar la geografía cambia la escala y obliga a recalibrar el umbral igual |
